...
Reuters_2020_Australia <-
  read_sav("~/Data/opinion_dynamics/02b_stance_detection/data/02_ground_truth_data/url_data/reuters_2020/Reuters_2020 - Australia.sav")
...
brand_mean <-  Reuters_2020_Australia[c(brand.df$var, "Q1F", "Q6_2016_Q6_2016_1_Q6_2016_grid")] %>%
  dplyr::mutate(id = 1:n()) %>%
...
library(data.table)
fwrite(reuters_2020_au_news_lr.df, "~/Data/opinion_dynamics/02b_stance_detection/data/02_ground_truth_data/url_data/reuters_processed_data/reuters_2020_au_news_lr.csv")


##### AUSTRALIA 2021

Reuters_2021_Australia <- read_sav("~/Data/opinion_dynamics/02b_stance_detection/data/02_ground_truth_data/url_data/reuters_2021/Reuters DNR 2021 - Australia.sav")
...
fwrite(reuters_2021_au_news_lr.df, "~/Data/opinion_dynamics/02b_stance_detection/data/02_ground_truth_data/url_data/reuters_processed_data/reuters_2021_au_news_lr.csv")

##### US 2020

Reuters_2020_USA <- read_sav("~/Data/opinion_dynamics/02b_stance_detection/data/02_ground_truth_data/url_data/reuters_2020/Reuters_2020 - USA.sav")
...
fwrite(reuters_2020_us_news_lr.df, "~/Data/opinion_dynamics/02b_stance_detection/data/02_ground_truth_data/url_data/reuters_processed_data/reuters_2020_us_news_lr.csv")

##### UK 2020
Reuters_2020_UK <- read_sav("~/Data/opinion_dynamics/02b_stance_detection/data/02_ground_truth_data/url_data/reuters_2020/Reuters_2020 - UK.sav")
...
fwrite(reuters_2020_uk_news_lr.df, "~/Data/opinion_dynamics/02b_stance_detection/data/02_ground_truth_data/url_data/reuters_processed_data/reuters_2020_uk_news_lr.csv")


##### Canada 2020
Reuters_2020_CA <- read_sav("~/Data/opinion_dynamics/02b_stance_detection/data/02_ground_truth_data/url_data/reuters_2020/Reuters_2020 - Canada.sav")
...
fwrite(reuters_2020_ca_news_lr.df, "~/Data/opinion_dynamics/02b_stance_detection/data/02_ground_truth_data/url_data/reuters_processed_data/reuters_2020_ca_news_lr.csv")


##### US 2021

Reuters_2021_USA <- read_sav("~/Data/opinion_dynamics/02b_stance_detection/data/02_ground_truth_data/url_data/reuters_2021/Reuters DNR 2021 - US.sav")
...
fwrite(reuters_2021_us_news_lr.df, "~/Data/opinion_dynamics/02b_stance_detection/data/02_ground_truth_data/url_data/reuters_processed_data/reuters_2021_us_news_lr.csv")


##### UK 2021
Reuters_2021_UK <- read_sav("~/Data/opinion_dynamics/02b_stance_detection/data/02_ground_truth_data/url_data/reuters_2021/Reuters DNR 2021 - UK.sav")
...
fwrite(reuters_2021_uk_news_lr.df, "~/Data/opinion_dynamics/02b_stance_detection/data/02_ground_truth_data/url_data/reuters_processed_data/reuters_2021_uk_news_lr.csv")


##### Canada 2021
Reuters_2021_CA <- read_sav("~/Data/opinion_dynamics/02b_stance_detection/data/02_ground_truth_data/url_data/reuters_2021/Reuters DNR 2021 - Canada.sav")
...
fwrite(reuters_2021_ca_news_lr.df, "~/Data/opinion_dynamics/02b_stance_detection/data/02_ground_truth_data/url_data/reuters_processed_data/reuters_2021_ca_news_lr.csv")


###### Combine the reuters and allsides datasets

# allsides_mine <- fread("~/Data/opinion_dynamics/02b_stance_detection/data/02_ground_truth_data/url_data/all_allsides_media_bias.csv")
...
allsides_official <- fread("~/Data/opinion_dynamics/02b_stance_detection/data/02_ground_truth_data/url_data/allsides_requested_data/AllSides-Media-Bias-Ratings_Publications_071822.csv") %>%
...
fwrite(domain_data, "~/Data/opinion_dynamics/02b_stance_detection/data/02_ground_truth_data/url_data/domain_allsides_reuters_lr.csv")
